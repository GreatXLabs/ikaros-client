...
const misionesData = {
	1042: { misionId: 1042, nombre: 'Implementación del módulo de Logs', descripcion: 'Desarrollo del sistema de auditoría y logs del sistema. Este módulo permitirá llevar un registro detallado de todas las operaciones realizadas en la plataforma.', fechaInicioEstimada: '2026-04-15T09:00', fechaFinEstimada: '2026-04-20T18:00' },
	1043: { misionId: 1043, nombre: 'Migración de base de datos', descripcion: 'Migración completa de MySQL a PostgreSQL', fechaInicioEstimada: '2026-04-10T08:00', fechaFinEstimada: '2026-04-18T17:00' },
	1044: { misionId: 1044, nombre: 'Diseño de interfaz de usuario', descripcion: 'Rediseño completo de la interfaz principal', fechaInicioEstimada: '2026-04-08T09:00', fechaFinEstimada: '2026-04-16T18:00' },
	1045: { misionId: 1045, nombre: 'Configuración de servidores', descripcion: 'Configuración de los servidores de producción', fechaInicioEstimada: '2026-04-22T10:00', fechaFinEstimada: '2026-04-25T16:00' },
	1046: { misionId: 1046, nombre: 'Integración de APIs externas', descripcion: 'Conexión con APIs de terceros para sincronización', fechaInicioEstimada: '2026-04-05T09:00', fechaFinEstimada: '2026-04-12T18:00' }
}
