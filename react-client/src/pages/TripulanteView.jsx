...
const tripulantesData = {
  1: {
    ...
    Sexo: 'M',
    aptitudes: [
      { id: 1, nombre: 'Piloto de naves', calificacion: 9, fechaExamen: '2026-01-15' },
      { id: 2, nombre: 'Reparación de sistemas', calificacion: 7, fechaExamen: '2026-02-20' },
      { id: 3, nombre: 'Primeros auxilios', calificacion: 8, fechaExamen: '2026-03-10' }
    ],
    misiones: [
      { misionId: 1042, nombre: 'Implementación del módulo de Logs', fechaInicioEstimada: '2026-04-15T09:00:00', fechaFinEstimada: '2026-04-20T18:00:00', estadoNombre: 'En curso' }
    ]
  },
  2: {
    TripulanteID: 2,
    ...
    Sexo: 'F',
    aptitudes: [
      { id: 1, nombre: 'Comunicaciones', calificacion: 10, fechaExamen: '2026-01-05' },
      { id: 2, nombre: 'Primeros auxilios', calificacion: 9, fechaExamen: '2026-02-15' }
    ],
    misiones: [
      { misionId: 1042, nombre: 'Implementación del módulo de Logs', fechaInicioEstimada: '2026-04-15T09:00:00', fechaFinEstimada: '2026-04-20T18:00:00', estadoNombre: 'En curso' },
      { misionId: 1043, nombre: 'Migración de base de datos', fechaInicioEstimada: '2026-04-10T08:00:00', fechaFinEstimada: '2026-04-18T17:00:00', estadoNombre: 'En curso' }
    ]
  },
  3: {
    TripulanteID: 3,
    ...
    Sexo: 'M',
    aptitudes: [
      { id: 1, nombre: 'Piloto de naves', calificacion: 6, fechaExamen: '2026-01-20' }
    ],
    misiones: [
      { misionId: 1043, nombre: 'Migración de base de datos', fechaInicioEstimada: '2026-04-10T08:00:00', fechaFinEstimada: '2026-04-18T17:00:00', estadoNombre: 'En curso' }
    ]
  ...
  4: {
    ...
    Sexo: 'F',
    aptitudes: [
      { id: 1, nombre: 'Ingeniería de propulsión', calificacion: 9, fechaExamen: '2026-03-01' },
      { id: 2, nombre: 'Reparación de sistemas', calificacion: 8, fechaExamen: '2026-03-15' }
    ],
    misiones: [
  ...
  6: {
    ...
    Sexo: 'F',
    aptitudes: [
      { id: 1, nombre: 'Médico de vuelo', calificacion: 10, fechaExamen: '2026-02-01' }
    ],
    misiones: []
  },
  7: {
    ...
    Sexo: 'M',
    aptitudes: [
      { id: 1, nombre: 'Navegación espacial', calificacion: 9, fechaExamen: '2026-01-10' },
      { id: 2, nombre: 'Comunicaciones', calificacion: 7, fechaExamen: '2026-02-25' }
    ],
    misiones: [
      { misionId: 1044, nombre: 'Diseño de interfaz de usuario', fechaInicioEstimada: '2026-04-08T09:00:00', fechaFinEstimada: '2026-04-16T18:00:00', estadoNombre: 'Completada' }
    ]
...
export function TripulanteView() {
  ...
  const ellipsisItems = [
    {
      label: 'Editar tripulante',
      onClick: () => navigate(`/Tripulantes/${id}/Editar`)
    },
    {
      label: 'Eliminar tripulante',
      variant: 'danger',
  ...
  return (
    <>
      ...
      {/* Modal de asignación de misiones */}
      {showAssignModal && (
      ...
      {showDeleteConfirm && (
        <div className="modal-overlay">
          <div className="modal-content">
            <h2>¿Eliminar tripulante?</h2>
            <p>Esta acción no puede ser revertida. Se eliminará permanentemente el tripulante y todos sus datos asociados.</p>
            <div className="modal-buttons">
